        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="kat-cell">
                        @php
                            $katLower = strtolower($k->nama_kategori);
                            $iconClass = str_contains($katLower,'makan') ? 'makanan' : (str_contains($katLower,'minum') ? 'minuman' : 'default');
                        @endphp
                        <div class="kat-icon {{ $iconClass }}">
                            @if($iconClass === 'minuman')
